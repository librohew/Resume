...
\item
  Proficient in OCaml, Markdown, LaTeX, C, HTML, Javascript, and SQL
%\item
 % Familiar with R, Standard ML, and the RISC-V
  %Instruction Set
\end{itemize}
...
\textbf{Elaine's Peacock Creative Writer's Group}, Long Hill, NJ  \\
\emph{Host/Facilitator @ \href{https://longhilllibrary.org/}{The Long Hill Township Library}},  August 2025 -- Present
\begin{itemize}
\tightlist
\item
Provide writing prompts for 1-6 people to honor late library patron Elaine 
\end{itemize}

\begin{itemize}
\tightlist
\item
Supply props such as cards and broken metronome to inspire creativity among fellow writers
\end{itemize}

\textbf{SADICAUIGA} \\
\emph{Best Overall Award - Team @ The University of Chicago}, July 2022 -- September 2022 %5, 2022 -- September 19, 2022
\begin{itemize}
\tightlist
\item
...
% \emph{Grader}, September 2024 -- Present

% \begin{itemize}
% \tightlist
% \item
%     Accurately grade homework for three Calculus I recitation sections    
% \end{itemize}

\textbf{NAMI NJ: Chinese-American Mental Health Outreach Program}, North Brunswick, NJ

\emph{Northern Regional Coordinator}, August 2025 -- Present

\begin{itemize}
\tightlist
\item
    Write monthly multicultural e-Newsletter sections and ensure publishing goes smoothly
\end{itemize}

\begin{itemize}
\tightlist
\item
    Attend weekly virtual work sessions with supervisor to gather and organize data for event locations  
\end{itemize}

\begin{itemize}
\tightlist
\item
    Coordinate library outreaches and major cultural events such as Lunar New Year Luncheon
\end{itemize}
...
\tightlist
\item
    Tutor 1-10 students at a time using a simultaneous-exhibition teaching style
\end{itemize}

\begin{itemize}
\tightlist
\item
    Maintain a friendly and warm learning environment for students
\end{itemize}

\textbf{Rutgers, The State University of New Jersey (Rutgers University)}, New Brunswick, NJ

\emph{Part-time Lecturer - CS 314 (Principles of Programming Languages)},  February 2025 -- May 2025
...
Relevant Coursework: Seminar in Computers and Society, Principles of Information and Data Management, Principles of Programming Languages, Systems Programming, Introduction to Discrete Structures II
...
\href{https://credentials.edx.org/credentials/de5d12ed05c8442e8b4c238fe2330132/}{Computational Thinking Using Python}, \href{https://courses.edx.org/certificates/427a45b7df034c2a9fb085b0993bdec0}{Multivariable Calculus 1: Vectors and Derivatives} 

%\textbf{Kean University}, Union, NJ

%\emph{Non-matriculated Undergraduate Visiting Student}, 2022 -- 2023
