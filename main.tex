...
\begin{center}
%mattli@uchicago.edu 
%ml1910@scarletmail.rutgers.edu
...
\item
  Proficient in C, R, Markdown, LaTeX, Javascript, and SQL
\item
  Familiar with HTML, Standard ML, Elm, Haskell, and the RISC-V
  Instruction Set
\end{itemize}
...
Relevant Coursework: Principles of Information and Data Management 
