...
Programming Languages, Analysis in $\mathbb{R}^n$ I, % Computer Architecture for Scientists, 
...
Relevant Coursework: %\href{https://courses.edx.org/certificates/dfd4b97d29cd408a985d6453a40d5424}{Chinese Language in Culture: Level 2}, 
...
\textbf{SADICAUIGA} \\
\emph{Best Overall Award - Team}, July 2022 -- September 2022 %5, 2022 -- September 19, 2022
\begin{itemize}
\tightlist
\item
...
\tightlist
\item
Wrote Python to produce Google Sheets formulas and comprehended C-and-HTML-producing code
\end{itemize}
...
\begin{itemize}
\item
  Proficient in Python, C, R, Markdown, \LaTeX, and Javascript
\item
